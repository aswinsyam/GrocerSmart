...
class Predict extends React.Component {
  ...
  handleOutletChangeFetchCategories = async (e) => {
    ...
    let response = await fetch(
      "http://localhost:5000/getcategoryBasedOnOutletIdentifier",
      requestOptions
    );
  ...
  handleSelectCategory = async (e) => {
    ...
    let response = await fetch(
      "http://localhost:5000/getitemsBasedOnCategory",
      requestOptions
    );
    response = await response.json();
  ...
  getItemDetails = async (e) => {
    ...
    let response = await fetch(
      "http://localhost:5000/getItemDetails",
      requestOptions
    );
    response = await response.json();
    console.log(response.data);
  ...
  callPredict = async () => {
    ...
    let response = await fetch("http://localhost:5000/getPrediction", requestOptions);
    response = await response.json();
