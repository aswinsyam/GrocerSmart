...
class Dashboard extends React.Component {
  ...
  handleOutletChangeFetchCategories = async (e) => {
    ...
    let response = await fetch("http://localhost:5000/getOutletOverview", requestOptions);
  ...
  searchData = async (e) => {
    ...
    let response = await fetch("http://localhost:5000/getitemdetailbasedOnitem", requestOptions);
    response = await response.json();
  ...
  searchsData = async (e) => {
    ...
    let response = await fetch("http://localhost:5000/compareitemsalesacrossoutlets", requestOptions);
    response = await response.json();
    let itemsalesData = [
      ['Outlet', 'Sales']
    ]
  ...
  handleTierlevelData = async (e) => {
    ...
    let response = await fetch("http://localhost:5000/getTierLevelOverview", requestOptions);
    response = await response.json();
  ...
  handleCategoryLevelData = async (e) => {
    ...
    let response = await fetch("http://localhost:5000/getItemFatContent", requestOptions);
    response = await response.json();
    console.log(response);
    ...
    let responseTwo = await fetch("http://localhost:5000/getitemnoBasedOnCategory", requestOptionsTwo);
